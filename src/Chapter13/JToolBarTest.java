...
public class JToolBarTest extends JFrame
{
    ...
    class OpenAction extends AbstractAction {
        ...
        public OpenAction() {
            // Настройка иконок
            putValue(AbstractAction.SMALL_ICON, new ImageIcon("C:\\Users\\Admin\\IdeaProjects\\Java_Methods_Programming\\src\\Chapter13\\images\\open.png"));
        }
        // Обработка действия
    ...
    class ExitAction extends AbstractAction {
        ...
        public ExitAction() {
            // Настройка иконок
            putValue(AbstractAction.SMALL_ICON, new ImageIcon("src\\Chapter13\\images\\exit.png"));
        }
        // Обработка действия
        public void actionPerformed(ActionEvent e) {
            System.exit(0);
